...
It was the worst of times.
    ...
    assert_equal 54, long_string.size #Incluye en el size los saltos de linea
  end
...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #
    # Because  plus operator creates a copy of the original String and de shovel operator
    # modifies the original one, generating less objects in memory
  end
